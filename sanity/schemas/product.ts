...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'number',
      group: 'details',
      description: 'Maximum Retail Price in INR. Set to 0 or leave empty for Price on Request.',
      initialValue: 0,
    ...
    defineField({
      ...
      type: 'array',
      group: 'details',
      description: 'Links to buy this product on different platforms',
      of: [
        {
          type: 'object',
          fields: [
            { name: 'platformName', title: 'Platform Name (e.g. Amazon, Swiggy)', type: 'string' },
    ...
    defineField({
      ...
      type: 'array',
      group: 'details',
      description: 'Add 4-5 descriptive sentences or bullet points about the item.',
      of: [{ type: 'string' }],
    }),
