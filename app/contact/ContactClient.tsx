          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col gap-8">
              <ScrollReveal direction="left">
                <h2 className="font-heading text-2xl font-black text-[#1B851B] mb-6">
                  Contact Information
                </h2>
                ...
                <div className="flex flex-col gap-6 text-dark">
                  ...
                  <div className="flex gap-4 items-start group">
                    <div className="w-12 h-12 rounded-xl bg-white text-[#FFD600] group-hover:text-[#1B851B] border border-green-dark/10 shadow-sm flex items-center justify-center shrink-0 transition-colors">
                      <MapPin className="w-6 h-6" />
                    </div>
                    <div>
                      <h4 className="font-bold text-sm uppercase text-dark/45 tracking-widest mb-1.5 font-mono">Address</h4>
                      <p className="text-dark hover:text-[#1B851B] transition-colors text-sm sm:text-base font-semibold font-mono leading-relaxed">
                  ...
                  <div className="flex gap-4 items-start group">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-dark hover:text-[#1B851B] text-sm sm:text-base font-semibold transition-colors font-mono"
                      >
                        +91 94460 06447
                      </a>
                    </div>
                  ...
                  {status === 'success' ? (
                    ...
                    >
                      <m.div
                        ...
                        className="w-16 h-16 bg-[#1B851B] text-white rounded-full flex items-center justify-center shadow-lg"
                      >
                        <CheckCircle className="w-9 h-9 text-white fill-current stroke-[#1B851B]" />
                      </m.div>
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-3">
                        <button
                          type="submit"
                          disabled={status === 'loading'}
                          className="w-full py-4 bg-[#1B851B] text-white hover:bg-green-brand font-black text-base uppercase tracking-widest rounded-xl transition-all shadow-md flex items-center justify-center gap-1.5 focus:outline-none focus:ring-2 focus:ring-[#FFD600] focus:ring-offset-2"
                        >
