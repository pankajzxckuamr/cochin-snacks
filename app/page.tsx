...
// import { BESTSELLER_PRODUCTS_QUERY, ALL_TESTIMONIALS_QUERY, ALL_COUNTRIES_QUERY, ALL_PLATFORMS_QUERY } from '@/lib/sanity/queries'
...
export default async function Home() {
  // Home landing content commented out — blank page
  return null

  // // Parallel fetch from Sanity CMS
  // const [rawBestsellers, rawTestimonials, rawCategories, countries] = await Promise.all([
  ...
  //   sanityFetch<any[]>(ALL_COUNTRIES_QUERY),
  // ])
